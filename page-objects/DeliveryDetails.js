...
export class DeliveryDetails{
    ...
    constructor (page){
        ...
        this.codePostalInput = page.locator('[data-qa="delivery-postcode"]')
    ...
    fillDetails = async (userAddress) => {
        ...
        await this.codePostalInput.waitFor()
        await this.codePostalInput.fill(userAddress.postcode)
    ...
    saveDetails = async () => {
        ...
        expect (await this.savedAddressPostCode.first().innerText()).toBe(await this.codePostalInput.inputValue())
