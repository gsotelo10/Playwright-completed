...
export class PaymentPage{
    constructor(page){
        ...
        this.creditCardValidInput = page.getByPlaceholder("Valid until")
    ...
    activateDiscount = async () => {
        ...
        const discountValueStringNumber = discountValueText.replace("$", "")
        const discountValueNumber = parseInt(discountValueStringNumber, 10)
        ...
        const totalValueStringNumber = totalValueText.replace("$", "")
